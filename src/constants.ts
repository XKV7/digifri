...
/** The min and max waves for mystery encounters to spawn in hardcore mode */
export const HARDCORE_MODE_MYSTERY_ENCOUNTER_WAVES: [number, number] = [10, 980] as const;
