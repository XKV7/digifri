...
export enum SettingKeyboard {
  ...
  BUTTON_QUICK_CONFIRM = "BUTTON_QUICK_CONFIRM",
}
...
export const settingKeyboardOptions = {
  ...
  [SettingKeyboard.BUTTON_QUICK_CONFIRM]: [`KEY ${Button.QUICK_CONFIRM.toString()}`, pressAction],
...
export const settingKeyboardDefaults = {
  ...
  [SettingKeyboard.BUTTON_QUICK_CONFIRM]: 0,
...
export function setSettingKeyboard(setting: SettingKeyboard, value: number): boolean {
  switch (setting) {
    ...
    case SettingKeyboard.BUTTON_QUICK_CONFIRM:
