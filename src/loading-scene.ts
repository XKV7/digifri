...
export class LoadingScene extends SceneBase {
  ...
  preload() {
    ...
    try {
      ...
      // Browsers without H.264 support throw when queueing the video;
      // skip the evolution background instead of aborting the whole preload.
      console.warn("VideoFile: skipping evo_bg (unsupported video format)");
    }
