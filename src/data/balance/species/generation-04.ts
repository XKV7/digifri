...
export function initGenerationFour(): SpeciesDataMapConfig {
  ...
  generationFourSpeciesData[SpeciesId.ADEUS] = {
    ...
    // The union of Dialga/Palkia/Giratina's own level-up movesets (see generation-04.ts entries
    // above), at whichever level the lowest of the three would learn each move.
    levelMoves: [
      [1, MoveId.SCARY_FACE],
      [1, MoveId.METAL_CLAW],
      [1, MoveId.WATER_PULSE],
